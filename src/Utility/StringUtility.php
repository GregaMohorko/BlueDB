...
abstract class StringUtility
{
	...
	/**
	 * Replaces all slavic characters to their normal equivalents.
	 * 
	 * @param string $text
	 * @return string
	 */
	public static function replaceSlavicCharsToNormalEquivalents($text)
	{
		//return mb_convert_encoding($text, "ISO-8859-2");
